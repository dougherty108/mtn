######## Ice Thickness Model for Green Lakes Valley Lakes 
# starting with GL4

# Authors
# Charlie Dougherty

# Ice thickness model adapted from C. Dougherty Thesis (unpublished)
# originally formulated for a permanent lake ice system on East Lake Bonney, Antarctica
# with a particular focus in shifting surface albedo estimates
# now will apply to a longer dataset from NWT LTER and Mountain Limnology Lab Data
